...
% <single> <integer> <large>
    ...
    methods
        ...
        function Setting(obj)
            ...
            disp("init finish!")
            confound = obj.confoundMarix;
            save("confound.mat", 'confound');
            conflict = obj.conflictMarix;
            save("conflict.mat", 'conflict');
            disturb = obj.disturbMarix;
            save("disturb.mat", 'disturb');
            disp("saved!")    
        end
